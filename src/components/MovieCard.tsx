  ...
  return (
    <>
      <Card
        ...
        className={`group relative overflow-hidden bg-gray-900 border-gray-800 hover:scale-105 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-2xl ${isTransitioning ? 'invisible' : ''
          }`}
      >
        <div className="aspect-[2/3] relative">
          ...
          {/* Type badge */}
          <div className={`absolute top-2 left-2 text-white text-xs px-2 py-1 rounded-full font-semibold ${movie.isSeries ? "bg-blue-600" : "bg-purple-600"
            }`}>
